...
- `/home/rpm/claude/nautobot/nautobot-app-floor-plan/nautobot_floor_plan/tests/js/floorplan-coords.test.js` — new node/jsdom pure-transform suite (8 tests, all pass).
